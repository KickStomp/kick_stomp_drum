...
float kick_wave, kick_f1, kick_f2, kick_tSweep, kick_aTime, kick_dTime, kick_sTime, kick_rTime, kick_aLevel, kick_dLevel, kick_sLevel, kick_rLevel, kick_dectime, noise_dectime;
...
void draw() {
 ...
 // line(0,0,200, 0);
  ...
  kick_dTime = kick_dectime/8.0;
  kick_dLevel = kick_aLevel/2.0;
  kick_sTime = kick_dectime/4.0;
  kick_sLevel = kick_aLevel/8.0;
  kick_rTime = kick_dectime*5.0/8.0;
  kick_rLevel = 0;
  ...
  kick_noise_dTime = noise_dectime/8.0;
  kick_noise_dLevel = kick_noise_aLevel/2.0;
  kick_noise_sTime = noise_dectime/4.0;
  kick_noise_sLevel = kick_noise_aLevel/8.0;
  kick_noise_rTime = noise_dectime*5.0/8.0;
  kick_noise_rLevel = 0;
