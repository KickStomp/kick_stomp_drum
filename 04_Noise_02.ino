...
int16_t noise1;
  ...
  // use different bits to create new noise streams, up to 8 different noise streams possible
  if(noise & 0b00000001) {noise1 = 127;} else{noise1 = -127;}
  
  new_audio = ((int16_t)((int8_t)noise1) << 6); // scale up to 14 bit +-8192 (hifimode)
